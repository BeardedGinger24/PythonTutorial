...
to order our code, make it more readable, reuse it and save some time. Also functions 
are a key way to define interfaces so programmers can share their code.
...
my_function_with_args("Mher", "Happy Holidays!")
...
within the brackets. For example, lets call the functions written above 
