...
modules in the Python standard library here(https://docs.python.org/3/library/).
...
inside that package called bar. We also must not forget to add the __init__.py file inside the 
foo directory.
...
In this exercise, you will need to print an alphabetically sorted list of all functions 
